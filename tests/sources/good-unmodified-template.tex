% =============================================================================
% good-unmodified-template -- the official USENIX Security template, verbatim.
%
% This is tests/template/usenixsecurity2027.tex unchanged (only this comment
% header is added). The unmodified template -- including its placeholder
% author block ("Your N. Here") -- must pass cleanly; if it ever does not, a
